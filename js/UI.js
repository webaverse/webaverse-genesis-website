...
const cycleLoader = () => {
    ...
    TweenLite.to( newLoaderSprite, 0.5, { y: 0, alpha: 1, ease: Power3.easeOut, delay: 0.2, onComplete: function(){
...
const hideSplash = () => {
   ...
   // TweenLite.to( spinnerContainer, 0.5, { opacity: 0, y:10, delay: 0.2, ease: Power3.easeIn} )
    ...
    TweenLite.to( ctaLoadingMessage, 0.5, { opacity: 0, y: 10, ease: Power3.easeIn, delay: 0.4, onComplete: function(){
        isLoading = false;
    ...
    TweenLite.to(uiBackground, 1, { opacity: 0, ease: Power3.easeOut, delay: 0.9, onComplete: function(){
        uiBackground.style.display = 'none'; 
    } } );

    
    TweenLite.to(uiTopContainer, 1, { opacity:1, ease: Power3.easeOut, delay: 1.5, onComplete: function() {
...
const cycleGenesis = () => {
    ...
    TweenLite.to( newGenesis, 0.5, { y: 0, alpha: 1, ease: Power3.easeOut, delay: 0.2, onComplete: function(){
        //cycleGenesis();
...
const updatePreload = ( perc ) => {
    ...
    TweenLite.to( loadbarAniObj, 1, { width: ( 100 * preloadCtr ), ease: Power3.easeOut, onUpdate: function(){
